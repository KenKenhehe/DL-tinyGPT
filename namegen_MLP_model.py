...
if __name__ == "__main__":
    words, itos, stoi = preprocess_dataset()
    vocab_size = len(itos)
    ...
    for i in tqdm.tqdm(range(step), desc="training"):
        #make mini batch
    ...
    chk_path = "MLP.pt"
    torch.save(chk_to_save, chk_path)
        
    print(f"model with loss {loss_data} saved to {chk_path}")